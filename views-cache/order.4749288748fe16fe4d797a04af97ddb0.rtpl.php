...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <br>
            <b>Emitido em:</b> <?php echo formateDate($order["dtregister"]); ?><br>
            <b>Pago em:</b> <?php echo formateDate($order["dtregister"]); ?>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>R$ <?php echo formatPrice($value1["vlprice"] * $value1["nrqtd"]); ?></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
